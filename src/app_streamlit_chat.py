...
- Path A (CC→Public): Total Cost: ${pathway_results['path_a']['cost']:,.0f}, 10yr Value: ${pathway_results['path_a']['value']:,.0f}
...
- Highlight community colleges with high transfer rates (≥9%)
